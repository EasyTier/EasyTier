...
The host-driven create schema is version 11 as of 2026-07-15. Peer configuration
...
Version 11 accepts normalized listener URLs, IPv6 policy, and `SocketContext`.
