...
The host-driven create schema is version 12 as of 2026-07-15. Peer configuration
...
Version 12 accepts normalized listener URLs, IPv6 policy, and `SocketContext`.
