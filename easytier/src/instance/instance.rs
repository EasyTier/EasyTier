...
impl Instance {
        ...
        tokio::spawn(async move {
            ...
            loop {
                ...
                if let Some(ip) = candidate_ipv4_addr {
                    ...
                    #[cfg(all(
                        not(any(target_os = "android", any(target_os = "ios", feature = "macos-ne"), target_env = "ohos")),
                        feature = "tun"
                    ))]
                    {
    ...
    pub async fn run(&mut self) -> Result<(), Error> {
        ...
        #[cfg(feature = "tun")]
        {
            ...
            #[cfg(not(any(target_os = "android", any(target_os = "ios", feature = "macos-ne"), target_env = "ohos")))]
