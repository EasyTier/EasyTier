...
function Get-EasyTier {
    ...
    if ($Tag -eq "latest") {
        ...
        try {
            Write-Host "获取指定版本: $Tag" -ForegroundColor Green
...
function Install-EasyTier {
    ...
    Write-Host "EasyTier $TargetVersion 已安装完成!" -ForegroundColor Green
}
