...
- an injected Go `SocketFactory` observes every connect, bind, and listen
  request with its normalized purpose, while the default implementation keeps
  the original standard-library behaviour;
