...
mod tests {
    ...
    use easytier::{
        ...
        instance::{
            ...
            factory::{
                NativeInstanceManager, native_instance_manager,
                native_instance_manager_with_runtime_config_projector,
            },
        },
        proto::{
    ...
    async fn compact_runtime_preserves_unsupported_web_config_during_hot_patch() {
        ...
        let core_manager = Arc::new(native_instance_manager_with_runtime_config_projector(
