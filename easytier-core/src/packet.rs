...
mod tests {
    ...
    fn rejects_zstd_compression_algo_without_zstd_feature() {
        assert!(CompressorAlgo::try_from(CompressionAlgoPb::Zstd).is_err());
    }

    #[test]
    #[cfg(feature = "zstd")]
    fn converts_zstd_compression_algo_with_zstd_feature() {
        assert_eq!(
