use super::{SocksError, consts};
use consts::SOCKS5_ADDR_TYPE_IPV4;
...
pub async fn read_address<T: AsyncRead + Unpin>(
    ...
    let addr = match atyp {
        consts::SOCKS5_ADDR_TYPE_IPV4 => {
            ...
            stream
                ...
                .await
                .context(AddrError::IPv4Unreadable)?;
            Addr::V4(bytes)
        }
        consts::SOCKS5_ADDR_TYPE_IPV6 => {
            ...
            stream
                .read_exact(&mut bytes)
                .await
                .context(AddrError::IPv6Unreadable)?;
            Addr::V6(bytes)
        }
        consts::SOCKS5_ADDR_TYPE_DOMAIN_NAME => {
            ...
            stream
                .read_exact(&mut len)
                .await
                .context(AddrError::DomainLenUnreadable)?;
    ...
    stream
        .read_exact(&mut port)
        .await
        .context(AddrError::PortNumberUnreadable)?;
