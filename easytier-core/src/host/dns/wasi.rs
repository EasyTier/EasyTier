...
unsafe extern "C" {
    fn start_dns_resolve(operation: u64, query: u32, query_len: u32) -> i32;
    fn take_dns_resolve(operation: u64, result: u32, result_capacity: u32) -> i32;
    fn start_dns_txt(operation: u64, query: u32, query_len: u32) -> i32;
    fn take_dns_txt(operation: u64, result: u32, result_capacity: u32) -> i32;
    fn start_dns_srv(operation: u64, query: u32, query_len: u32) -> i32;
    fn take_dns_srv(operation: u64, result: u32, result_capacity: u32) -> i32;
